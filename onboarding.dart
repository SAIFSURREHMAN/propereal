        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: PText("Make a living easy,Chores are done hassle-free Complete home solutions,  Experience fine  living, Get the best appliances The best performance \n around."),
            ),
            SizedBox(height: 45),
            Center(
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Center(child: PText("Get Started",color: Colors.white,fontSize: 18,)),
                ),
              ),
            ),
          ],
